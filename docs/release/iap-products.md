...
| `com.shuhirouchi.oikomi.tip.pocari` | Consumable | 120 | 開発支援チップ（最小） |
...
|---|---|---|---|---|---|---|
| `Tip - Pocari` | `com.shuhirouchi.oikomi.tip.pocari` | ¥120 | `🥤 ポカリ 1 本` | `ポカリ 1 本分の応援。ありがとうございます！` | `🥤 Sports Drink` | `Buy the developer a sports drink.` |
